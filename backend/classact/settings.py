"""
Django settings for classact project.
...
SECRET_KEY = 's)ju%9^%17p#we_ejk7$&vfj99yt73nqvo61gj(o%q^g5x19@c'
...
WSGI_APPLICATION = 'classact.wsgi.application'
